...
void SimpleARClass::PerformGLInits() {
    ...
    std::string objFilename, mtlFilename, texFilename1, texFilename2, texFilename3, texFilename4;
    bool isFilesPresent  =
            ...
            gHelperObject->ExtractAssetReturnFilename("amenemhat/message_01.png", texFilename4);
...
//    DrawShiftedCorners(cameraImageForBack, homography);
    DrawMessage(cameraImageForBack);
    return true;
}
